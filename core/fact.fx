...
FactSimilarity(left: any, right: any, result: any) =>
    result := fact.check_similarity(fact1: left, fact2: right, algorithm: "semantic_recursive").

FactDifference(left: any, right: any, result: any) =>
    result := fact.check_difference(fact1: left, fact2: right).

FactPropertyComparison(left: any, right: any, result: any) =>
    result := fact.compare_properties(fact1: left, fact2: right).

FactCommonAncestor(left: any, right: any, result: any) =>
    result := fact.common_ancestor(fact1: left, fact2: right).

Near(left: any, right: any, threshold: number, score: any) =>
