...
system.flibrary.fact.contains_subfact(input: any, candidate: any, maximum_depth: number) => ()
system.flibrary.fact.relation_properties(pairs: array) => ()
system.flibrary.fact.nearest_subfacts(input: any, maximum_depth: number) => ()
