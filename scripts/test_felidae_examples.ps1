...
$directTests = @(
    ...
    @{ Name = "expert system exact proof and evidence isolation"; Args = @("examples\expert_system_acceptance.fx"); Expect = @('proof_status: "proved"', 'conclusion: "eligible"', 'proof_status: "not_proved"', 'proof_status: "evidence_only"', "contradictory: true", 'evidence_sources: ["recent_income_signal", "missing_document_signal"]') },
