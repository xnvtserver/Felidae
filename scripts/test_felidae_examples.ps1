...
$directTests = @(
    ...
    @{ Name = "v2 animal fact similarity evidence"; Args = @("v2_examples\animal_fact_similarity_evidence.fx"); Expect = @('female_tiger_to_female_cat: AnimalSimilarityEvidence(', 'left_type: "TigerFemale"', 'right_type: "CatFemale"', 'score: 0.75', 'male_tiger_to_female_cat: AnimalSimilarityEvidence(', 'score: 0.375', 'male_tiger_to_male_cat: AnimalSimilarityEvidence(', 'male_tiger_to_female_tiger: AnimalSimilarityEvidence(', 'PropertyEvidence(property: "produces_milk"') },
