...
DocSearchEntry(id: "lib-db", title: "Library: db", route: "#lib-db", tags: "db fact database no sql query", summary: "No-SQL access to loaded facts with db.all, db.find, db.first, db.count, db.types, and db.fields.", searchText: "library db facts database no sql all find first count types fields main methods").
...
DocSearchEntry(id: "lib-csv", title: "Library: csv", route: "#lib-csv", tags: "csv rows table facts import export", summary: "CSV parsing, row updates, exports, and fact generation.", searchText: "library csv parse rows addRow findRows updateRows deleteRows toFacts toFelidaeFacts table import export").
...
DocSearchEntry(id: "lib-http", title: "Library: http", route: "#lib-http", tags: "http server hosting request response", summary: "HTTP client calls, response helpers, and static documentation serving.", searchText: "library http get post put delete serveStatic HttpResponse HttpHtmlResponse HttpServeResponse server hosting").
...
DocSearchEntry(id: "lib-ml", title: "Library: ml", route: "#lib-ml", tags: "ml vector scoring activation", summary: "Small vector scoring and activation helpers.", searchText: "library ml sigmoid relu dot meanSquaredError vector scoring activation").
...
DocSearchEntry(id: "lib-process", title: "Library: process", route: "#lib-process", tags: "process platform exec sleep host", summary: "Platform detection, host command execution, and sleep.", searchText: "library process platform exec sleep host command operational").
