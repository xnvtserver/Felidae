...
DocsVersion() =>
    ...
    return (HtmlRichSectionData(id: "version", title: "Version And Release Notes", p: "Docs version: 2026-07-13 local documentation snapshot. This version reflects the current checkout, README.md, docs_language.md, and the generated Felidae SPA under docs/.", p2: "The product split is Felidae for execution, felidae_debug for compiler diagnostics and LSP, and Celidae for fact relationship visualization. The docs site is a living release surface: supported syntax, libraries, editor setup, download guidance, and runtime commands are recorded directly in Felidae files.", content: content, code: "./build/felidae program.fx\n./build/felidae_debug program.fx --check-json\n./build/celidae program.fx --inspect-graph\n./build/celidae program.fx --html --load-imports\n./build/felidae_debug --lsp", note: "Version pages should be updated when syntax contracts change, especially stdlib method names like str.concat(left: ..., right: ...), main() query guidance, download paths, Linux hosting, or debugger and visualizer ownership.", code2: "Compiler debugger on Windows:\nbuild\\felidae_debug.exe program.fx --check-json\n\nCompiler debugger on Linux:\n./build/felidae_debug program.fx --check-json\n\nCanonical notes:\ndocs_language.md\nREADME.md")).
