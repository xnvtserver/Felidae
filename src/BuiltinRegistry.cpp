...
constexpr BuiltinInfo kBuiltinInfos[] = {
        ...
        {BuiltinId::CsvAddRow, "csv:addRow", BuiltinEffect::Pure},
        {BuiltinId::CsvFindRows, "csv:findRows", BuiltinEffect::Pure},
        {BuiltinId::CsvUpdateRows, "csv:updateRows", BuiltinEffect::Pure},
        {BuiltinId::CsvDeleteRows, "csv:deleteRows", BuiltinEffect::Pure},
        {BuiltinId::DbAll, "db:all", BuiltinEffect::ReadsExternalState},
        {BuiltinId::DbFind, "db:find", BuiltinEffect::ReadsExternalState},
        {BuiltinId::DbCount, "db:count", BuiltinEffect::ReadsExternalState},
        ...
        {BuiltinId::HttpGet, "http:get", BuiltinEffect::ReadsExternalState},
        {BuiltinId::HttpPost, "http:post", BuiltinEffect::WritesExternalState},
        {BuiltinId::HttpPut, "http:put", BuiltinEffect::WritesExternalState},
        {BuiltinId::HttpDelete, "http:delete", BuiltinEffect::WritesExternalState},
        {BuiltinId::HttpServeStatic, "http:serveStatic", BuiltinEffect::WritesExternalState},
        {BuiltinId::ProcessPlatform, "process:platform", BuiltinEffect::ReadsExternalState},
        {BuiltinId::ProcessExec, "process:exec", BuiltinEffect::WritesExternalState},
        {BuiltinId::ProcessSleep, "process:sleep", BuiltinEffect::Volatile},
