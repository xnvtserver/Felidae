...
inline constexpr std::size_t kMixfixStructuralVocabularySize =
    3 + static_cast<std::size_t>(kIrOpcodeCount) + kMaximumMixfixRegisters +
    4 * kMaximumMixfixReferences;
...
public:
  ...
  virtual std::vector<MixfixVocabularyId>
